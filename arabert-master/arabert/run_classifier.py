    ...
    def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            def metric_fn(per_example_loss, label_ids, logits, is_real_example):
                ...
                # true_pos = tf.metrics.true_positives(labels=label_ids,predictions=predictions, weights=is_real_example)
                
                # false_pos = tf.metrics.false_positives(labels=label_ids,predictions=predictions, weights=is_real_example)

                # true_neg = tf.metrics.true_negatives(labels=label_ids,predictions=predictions, weights=is_real_example)

                # false_neg = tf.metrics.false_negatives(labels=label_ids,predictions=predictions, weights=is_real_example)
                return {

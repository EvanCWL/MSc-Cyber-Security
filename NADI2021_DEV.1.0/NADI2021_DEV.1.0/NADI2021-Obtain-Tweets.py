...
def print_usage():
    ...
    print (
    '''Usage:
    python3 NADI-Obtain-Tweets.py  <input_file> <output_file>
    
    The input file must be in the same format as the unlabeled_10M.tsv. 
...
if __name__ == '__main__':
    ...
    consumer_key='elgZX50yO3lVuOHXJEyVkmoMT'
    consumer_secret='yPaTfQVmsd7K7vvGyNIBvEiRnHhLjWxTUUAex1BIa2gQvaMRhQ'
    access_token='1412074530533687298-4JxFQBNqzJyopeCleuAgsEK4R56Col'
    access_secret='OPhLIUetOwUgAxNDu1zctehLgbZx0kV2SaLbwJpL4VWTf'
    ...
    with open(readfile, "rb") as csvread:
        with open(writefile, "wb") as csvwrite:
            ...
            for row in csvreader:
                ...
                if (i == 0):
                    num_cols = len(row)
                    current_row = row + ["#"+ str(num_cols + 1)+ " tweet_content"]
                    csvwriter.writerow(current_row)
                    i += 1
                else:
